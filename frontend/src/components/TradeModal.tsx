            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  step="0.001"
                  min="0.001"
                  className="w-full px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg font-medium"
                  disabled={isLoading}
                />
              ...
              <div className="flex gap-2 mt-2">
                {["0.01", "0.05", "0.1", "0.5"].map((val) => (
                  <button
                    ...
                    className="flex-1 py-1.5 rounded-lg text-xs font-medium bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-600 dark:text-zinc-400 transition"
                  >
                    {val}
                  </button>
                ))}
