    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md bg-green-900/20 p-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-green-800/30 text-green-300">
            {walletLabel}
          </span>
        </div>
      ...
      {isMetaMask ? (
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1 text-xs text-zinc-400 hover:text-zinc-300 py-1"
          >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="bg-zinc-900 rounded p-2">
                      <p className="text-zinc-400">Gateway</p>
