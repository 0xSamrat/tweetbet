...
contract MarketFactoryTest is Test {
    ...
    function test_HappyPath_CreateMarketAndTrade() public {
        ...
        // Resolver resolves market with random outcome
        vm.prank(resolver);
        marketFactory.resolve(marketId, yesWins);
        ...
        if (yesWins) {
            // YES wins - Users 1, 2, 3 are winners
            console.log("\n  YES won! Users 1, 2, 3 can claim.");
            
            console.log("\nUser 1 claiming (bought YES - WINNER)...");
            vm.prank(user1);
            (user1Shares, user1Payout) = marketFactory.claim(marketId, user1);
            console.log("  Shares burned:", user1Shares);
            console.log("  ETH received:", user1Payout);
            
            console.log("\nUser 2 claiming (bought YES - WINNER)...");
            vm.prank(user2);
            (user2Shares, user2Payout) = marketFactory.claim(marketId, user2);
            console.log("  Shares burned:", user2Shares);
            console.log("  ETH received:", user2Payout);
            
            console.log("\nUser 3 claiming (bought YES - WINNER)...");
            vm.prank(user3);
            (user3Shares, user3Payout) = marketFactory.claim(marketId, user3);
            console.log("  Shares burned:", user3Shares);
            console.log("  ETH received:", user3Payout);
            
            console.log("\nUser 4 (bought NO - LOSER) - No winning tokens");
            console.log("\nUser 5 (bought NO - LOSER) - No winning tokens");
            
        } else {
            // NO wins - Users 4, 5 are winners
            console.log("\n  NO won! Users 4, 5 can claim.");
            
            console.log("\nUser 1 (bought YES - LOSER) - No winning tokens");
            console.log("\nUser 2 (bought YES - LOSER) - No winning tokens");
            console.log("\nUser 3 (bought YES - LOSER) - No winning tokens");
            
            console.log("\nUser 4 claiming (bought NO - WINNER)...");
            vm.prank(user4);
            (user4Shares, user4Payout) = marketFactory.claim(marketId, user4);
            console.log("  Shares burned:", user4Shares);
            console.log("  ETH received:", user4Payout);
            
            console.log("\nUser 5 claiming (bought NO - WINNER)...");
            vm.prank(user5);
            (user5Shares, user5Payout) = marketFactory.claim(marketId, user5);
            console.log("  Shares burned:", user5Shares);
            console.log("  ETH received:", user5Payout);
        }
        ...
        console.log("      change:", int256(user1.balance) - int256(user1BalBefore));
        console.log("    User 2:", user2.balance);
        console.log("      change:", int256(user2.balance) - int256(user2BalBefore));
        console.log("    User 3:", user3.balance);
        console.log("      change:", int256(user3.balance) - int256(user3BalBefore));
        console.log("    User 4:", user4.balance);
        console.log("      change:", int256(user4.balance) - int256(user4BalBefore));
        console.log("    User 5:", user5.balance);
        console.log("      change:", int256(user5.balance) - int256(user5BalBefore));
        ...
        if (yesWins) {
            ...
            console.log("    User 1: Spent 1 ETH, received 0 = LOSS");
            console.log("    User 2: Spent 1.5 ETH, received 0 = LOSS");
            console.log("    User 3: Spent 2 ETH, received 0 = LOSS");
            console.log("    User 4: Spent 1 ETH, received (wei):", user4Payout);
            console.log("      Result:", user4Payout > 1 ether ? "PROFIT" : "LOSS");
            console.log("    User 5: Spent 0.5 ETH, received (wei):", user5Payout);
            console.log("      Result:", user5Payout > 0.5 ether ? "PROFIT" : "LOSS");
        }
        ...
        console.log("    User 4 NO:", marketFactory.balanceOf(user4, noId));
        console.log("    User 5 NO:", marketFactory.balanceOf(user5, noId));
        
        // Verify claims were successful based on outcome
        if (yesWins) {
            ...
            assertEq(marketFactory.balanceOf(user1, marketId), 0, "User 1 YES balance should be 0");
            assertEq(marketFactory.balanceOf(user2, marketId), 0, "User 2 YES balance should be 0");
            assertEq(marketFactory.balanceOf(user3, marketId), 0, "User 3 YES balance should be 0");
        } else {
            assertGt(user4Payout, 0, "User 4 should have received payout");
            assertGt(user5Payout, 0, "User 5 should have received payout");
            assertEq(marketFactory.balanceOf(user4, noId), 0, "User 4 NO balance should be 0");
            assertEq(marketFactory.balanceOf(user5, noId), 0, "User 5 NO balance should be 0");
        }
    }
